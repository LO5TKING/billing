...
class TermsAndConditionSettings extends StatelessWidget {
  const TermsAndConditionSettings({super.key});
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Row(
                              children: [
                                const Icon(Icons.branding_watermark_sharp,size: 40,color: AppColors.blueGradient,),
                                const SizedBox(width: DesignConstants.padding20,),
                                shadowText(text: 'Terms and Condition'),
