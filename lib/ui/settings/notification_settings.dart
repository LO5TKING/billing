                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Row(
                              children: [
                                const Icon(Icons.notifications,size: 40,color: AppColors.blueGradient,),
                                const SizedBox(width: DesignConstants.padding20,),
                                shadowText(text: 'Notification'),
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Container(
                                    child: shadowText(text: 'Sale report Notification Schedule',fontWeight: FontWeight.w400),
                                  )
                                ],
                              ),
                            ),
