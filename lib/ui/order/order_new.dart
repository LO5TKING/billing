...
class OrderNew extends StatefulWidget {
  ...
  const OrderNew({super.key, this.customer});
...
class _OrderNewState extends State<OrderNew> {
  OrderControllerNew orderControllerNew = Get.find<OrderControllerNew>();
  ...
  Widget build(BuildContext context) {
    return GetBuilder<OrderControllerNew>(
      builder: (context) {
        return SafeArea(
          child: Stack(
            children: [
              GestureDetector(
                ...
                onTap: () {
                  ...
                  if (orderControllerNew.currentRateItemIndex.value >= 0) {
                    // Pass the current index to cancelRateEdit
                    int currentIndex =
                        orderControllerNew.currentRateItemIndex.value;
                    orderControllerNew.cancelRateEdit(currentIndex);
                  }
                },
                child: Scaffold(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                InkWell(
                                  onTap: () {
                                    orderControllerNew.clearPadAndSignature();
                                  },
                                  child: Container(
                                    height: 35,
                                    width: 35,
                                ...
                                IconButton(
                                    onPressed: () async {
                                      await orderControllerNew.addItem();
                                      orderControllerNew.clearPadAndSignature();
                                    },
                                ...
                                children: [
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      Table(
                                        columnWidths: {
                                          0: FixedColumnWidth(orderControllerNew
                                                  .showButtons.value
                                              ? 0.0
                                              : 100),
                                          // Sr.No
                                          ...
                                          // Particulars
                                          2: FixedColumnWidth(orderControllerNew
                                                  .showButtons.value
                                              ? 120.0
                                              : 100),
                                          // QTY
                                          3: FixedColumnWidth(orderControllerNew
                                                  .showButtons.value
                                              ? 220.0
                                              : 200),
                                          // Rate
                                          4: FixedColumnWidth(orderControllerNew
                                                  .showButtons.value
                                              ? 125.0
                                              : 100),
                                          // Amount
                                      ...
                                      Expanded(
                                        child: ListView.builder(
                                          itemCount: orderControllerNew
                                              .itemList.length,
                                          padding: EdgeInsets.zero,
                                          controller: scrollController,
                                          // Disable scrolling when editing a rate box or when drawing ink
                                          physics: orderControllerNew
                                                          .currentRateItemIndex
                                                          .value >=
                                                      0 ||
                                                  orderControllerNew
                                                      .ratePoints.isNotEmpty
                                              ? const NeverScrollableScrollPhysics()
                                              : const AlwaysScrollableScrollPhysics(),
                                          itemBuilder: (context, index) {
                                            final item = orderControllerNew
                                                .itemList[index];
                                                                  ...
                                                                  : Material(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration:
                                                                            BoxDecoration(
                                                                          border:
                                                                              Border.all(color: AppColors.blueGradient),
                                                                        ),
                                                                        alignment:
                                                                            Alignment.center,
                                                                        child:
                        ...
                        Obx(
                          () => Table(
                            ...
                            columnWidths: {
                              ...
                              1: const FlexColumnWidth(),
                              2: FixedColumnWidth(
                                  orderControllerNew.showButtons.value
                                      ? 120.0
                                      : 100),
                              3: FixedColumnWidth(
                                  orderControllerNew.showButtons.value
                              ...
                              TableRow(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      '${orderControllerNew.totalAmount}',
                                      style: const TextStyle(
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold),
                                      textAlign: TextAlign.center,
                ...
                child: Listener(
                  onPointerDown: (event) {
                    ...
                    if (isTouchInsideBox(
                      ...
                      orderControllerNew.ratePoints.add(StrokePoint(
                      ...
                      if (itemIndex != null &&
                          itemIndex >= 0 &&
                          itemIndex < orderControllerNew.rateInkList.length) {
                        orderControllerNew.rateInkList[itemIndex].strokes
                            .add(Stroke());
                      } else {
                        orderControllerNew.rateInk.strokes.add(Stroke());
                      }
                      orderControllerNew.update();
                    }
                  },
                  onPointerMove: (event) {
                    // Use the current item's ink object if an index is provided
                    Ink inkToUse = (itemIndex != null &&
                            itemIndex >= 0 &&
                            itemIndex < orderControllerNew.rateInkList.length)
                        ? orderControllerNew.rateInkList[itemIndex]
                        : orderControllerNew.rateInk;
                    ...
                    if (inkToUse.strokes.isNotEmpty) {
                      ...
                      orderControllerNew
                          .update(); // Update the ink state in controller
                    }
                  },
                  onPointerUp: (event) {
                  ...
                  child: CustomPaint(
                    painter: SignatureStyle(
                        ink: (itemIndex != null &&
                                itemIndex >= 0 &&
                                itemIndex <
                                    orderControllerNew.rateInkList.length)
                            ? orderControllerNew.rateInkList[itemIndex]
                            : orderControllerNew.rateInk),
                    size: Size.infinite,
                  ),
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    orderControllerNew.cancelRateEdit(itemIndex);
                  },
                  child: Container(
                    decoration: const BoxDecoration(
    ...
    return Stack(
      ...
      children: [
          ...
          child: ClipRRect(
            child: Listener(
              onPointerDown: (event) {
                if (isTouchInsideBox(
                    event.localPosition, Get.width * widthFactor)) {
                  orderControllerNew.quantityInk.strokes.add(Stroke());
                  orderControllerNew.update();
                }
              },
              onPointerMove: (event) {
                ...
                if (localPosition != null) {
                  orderControllerNew.quantityInk.strokes.last.points.add(
                    StrokePoint(
                      x: localPosition.dx,
                      y: localPosition.dy,
                      t: DateTime.now().millisecondsSinceEpoch,
              ...
              child: CustomPaint(
                painter: SignatureStyle(ink: orderControllerNew.quantityInk),
                size: Size.infinite,
              ),
            ),
          ),
        ...
        Positioned(
          ...
          child: GestureDetector(
            onTap: () {
              orderControllerNew.quantityInk.strokes.clear();
              orderControllerNew.quantityPoints.clear();
              orderControllerNew.update();
            },
            child: Container(
              decoration: const BoxDecoration(
              ...
              child:
                  const Icon(Icons.cancel_outlined, color: AppColors.blackLead),
            ),
          ),
        ),
      ],
    ...
    return Stack(
      ...
      children: [
          ...
          child: ClipRect(
            child: Listener(
              onPointerDown: (event) async {
                if (isTouchInsideBox(
                    event.localPosition, Get.width * widthFactor)) {
                  orderControllerNew.descriptionInk.strokes.add(Stroke());
                  orderControllerNew.update();
                }
              },
              onPointerMove: (event) async {
                ...
                final localPosition =
                    (object as RenderBox?)?.globalToLocal(event.localPosition);
                if (localPosition != null &&
                    orderControllerNew.descriptionInk.strokes.isNotEmpty) {
                  orderControllerNew.descriptionInk.strokes.last.points.add(
                    StrokePoint(
                      x: localPosition.dx,
                      y: localPosition.dy,
                      t: DateTime.now().millisecondsSinceEpoch,
              ...
              child: CustomPaint(
                painter: SignatureStyle(ink: orderControllerNew.descriptionInk),
                size: Size.infinite,
              ),
            ),
          ),
        ...
        Positioned(
          ...
          child: GestureDetector(
            onTap: () {
              orderControllerNew.descriptionInk.strokes.clear();
              orderControllerNew.descriptionPoints.clear();
              orderControllerNew.update();
            },
            child: Container(
              decoration: const BoxDecoration(
  ...
  bool isTouchInsideBox(Offset localPosition, double widthFactor) {
    ...
    double boxWidth =
        widthFactor is double ? Get.width * widthFactor : widthFactor;
...
class SignatureStyle extends CustomPainter {
  Ink? ink;
  var controller = Get.put(OrderControllerNew());
    ...
    return Obx(
      () => Row(
        children: [
          ...
          SizedBox(width: orderControllerNew.showButtons.value ? 0.0 : 100),
          // Vertical line
          _buildVerticalLine(),
          ...
          SizedBox(width: orderControllerNew.showButtons.value ? 118.0 : 98),
          // You might need to adjust this with Obx() if it changes
          // Vertical line
          _buildVerticalLine(),

          // Fourth column (Rate - 100/120px based on showButtons)
          SizedBox(width: orderControllerNew.showButtons.value ? 220.0 : 200),
          // You might need to adjust this with Obx() if it changes
          // Vertical line
          _buildVerticalLine(),

          // Fifth column (Amount - 100/120px based on showButtons)
          SizedBox(width: orderControllerNew.showButtons.value ? 145.0 : 120),
          // You might need to adjust this with Obx() if it changes
        ],
      ),
    );
