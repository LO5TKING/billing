            ...
            children: [
              PopScope(
                ...
                onPopInvokedWithResult: (didPop, result) {
                  // This is called after the pop happens
                  if (didPop) {
                    // Clean up if needed
                  ...
                  body: Container(
                    ...
                    child: Column(
                      children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Obx(() => Text(
                                        billingController.formattedDateTime.value,
                              ...
                              children: [
                                ...
                                IconButton(
                                    ...
                                    icon: const Icon(Icons.add_box_rounded,
                                        color: AppColors.blueGradient, size: 30)),
                              ],
                            )
                          ],
                        ),
                                            ...
                                            children: [
                                              Expanded(
                                                child: Table(
                                                  columnWidths: {
                                                    ...
                                                    2: FixedColumnWidth(billingController.showButtons.value ? 130.0 : 120),
                                                    3: FixedColumnWidth(billingController.showButtons.value ? 130.0 : 120),
                                                    4: FixedColumnWidth(billingController.showButtons.value ? 140.0 : 130),
                                                  },
                                                  children: [
                                                    TableRow(
                                                      children: [
                                              ...
                                              Obx(() => Visibility(
                                                ...
                                                child: GestureDetector(
                                                  onTap: () {
                                                    billingController.editItem(index);
                                                  },
                                                  onDoubleTap: () {
                                                    billingController.deleteItem(index);
                                                  },
                                                  child: Container(
                                                    width: 15.0,
                                                    height: 15.0,
                                                    margin: const EdgeInsets.only(bottom: 25.0, right: 10),
                        ...
                        // Total row
                        Obx(() => Table(
                          border: TableBorder.all(color: AppColors.blueGradient),
                          columnWidths: {
                            0: const FixedColumnWidth(60.0),
                            1: const FlexColumnWidth(),
                            2: FixedColumnWidth(billingController.showButtons.value ? 120.0 : 100),
                            3: FixedColumnWidth(billingController.showButtons.value ? 121.0 : 100),
                            4: FixedColumnWidth(billingController.showButtons.value ? 145.0 : 120),
                          },
                          children: [
                            TableRow(
                              decoration: const BoxDecoration(color: AppColors.blueGradient),
                              children: [
                                const TableCell(
                                  child: Padding(
                                    padding: EdgeInsets.all(8.0),
                                ...
                                TableCell(
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text('${billingController.totalQty}',
                                        textAlign: TextAlign.center,
                            ...
                            children: [
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: ElevatedButton(
                                            ...
                                            onPressed: () async {
                                              File? pdfFile = await billingController.saveReceiptAsPdf();
                              ...
                              Visibility(
                                ...
                                child: Container(
                                  ...
                                  child: IconButton(
                                      onPressed: () {
                                        billingController.showButtons.value = !billingController.showButtons.value;
                                      },
                                      icon: const Icon(
...
// SignatureStyle class for custom painting
  ...
  Widget build(BuildContext context) {
    return Obx(() => Row(
      children: [
        ...
        SizedBox(
            width: billingController.showButtons.value
                ? 118.0
