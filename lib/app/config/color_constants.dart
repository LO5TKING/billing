...
class AppColors {
  ...
  static const blueGradient  =  Color(0xFF0000FF);
  static const lightBlueGradient  =  Color(0xACA3BEFF);
  static const lightPurpleGradient  =  Color(0xACBAB6F5);
  static const lightYelloGradient  =  Color(0xFFEEEBD5);
  static const stainedGlass  =  Color(0xFF556386);
  ...
  //text colors
  static const blackTextColor  =  Color(0xE4F3DB57);
  static const lightBlueTextColor  =  Color(0xFFDE4664);
